...
(
    ...
    CONSTRAINT FK_USER_ROLE_USER_ID FOREIGN KEY (USER_ID) REFERENCES HANDCRAFTED_SCHEMA.USER (ID)
);
...
(
    ...
    CONSTRAINT FK_FAVORITE_PRODUCT_USER_ID FOREIGN KEY (USER_ID) REFERENCES HANDCRAFTED_SCHEMA.USER (ID),
    CONSTRAINT FK_FAVORITE_PRODUCT_PRODUCT_ID FOREIGN KEY (PRODUCT_ID) REFERENCES HANDCRAFTED_SCHEMA.PRODUCT (ID)
);
...
(
    ...
    CONSTRAINT FK_PRODUCT_IN_CART_USER_ID FOREIGN KEY (USER_ID) REFERENCES HANDCRAFTED_SCHEMA.USER (ID),
    CONSTRAINT FK_PRODUCT_IN_CART_PRODUCT_ID FOREIGN KEY (PRODUCT_ID) REFERENCES HANDCRAFTED_SCHEMA.PRODUCT (ID)
    );
...
(
    ...
    CONSTRAINT FK_PRODUCT_IN_ORDER_PRODUCT_ID FOREIGN KEY (PRODUCT_ID) REFERENCES HANDCRAFTED_SCHEMA.PRODUCT (ID),
    CONSTRAINT FK_PRODUCT_IN_ORDER_ORDER_ID FOREIGN KEY (ORDER_ID) REFERENCES HANDCRAFTED_SCHEMA.ORDER (ID)
);